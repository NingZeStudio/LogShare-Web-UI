export const zhCN = {
  ...
  no_results: '未找到结果',
  friend_links: '友情链接',
  edgeone_distribution: 'EdgeONE 提供 CDN 服务',
  waf_protecting: 'OpenLiteWaf 防护中',
  footer_contact: '联系方式',
  terms_of_service: '服务协议',
  legal_provisions: '条款与政策',
  terms_summary: 'LogShare.CN 平台使用规则与权利义务约定',
  privacy_summary: '关于我们在您使用服务期间如何保护及处理您的日志与遥测数据',
  theme_light: '浅色',
  theme_dark: '深色',
  theme_system: '跟随系统',
  ...
  save_log: '保存日志',
  saving: '保存中...',
  file_too_large_10mib: '文件过大 (最大 10 MiB)',
  ...
  button: '按钮',
  integration_text:
    '直接集成到您的服务器面板、托管软件或任何其他平台中。此平台专为高性能自动化而构建，可通过我们的 HTTP API 轻松集成到任何现有软件中。',
  paste_log: '粘贴日志文件',
  ...
  delete_log_confirm_no_token: '未找到删除令牌，删除可能会失败。',
  delete_log_success: '日志已成功删除',
  delete_log_failed: '删除失败',
  delete_log_no_token: '未找到删除令牌，无法删除日志',
  deleting: '删除中...',
  ...
  content_limit: '内容限制',
  storage_time: '存储时间',
  instant_analysis_desc:
    '上传并分析日志内容，但不会将其永久保存到我们的数据库中。适用于只需要分析结果而不需要分享链接的场景。',
  ...
  announcement_qq_group_desc:
    '欢迎加入我们的官方 QQ 交流群，与其他用户交流经验，获取最新技术支持和更新资讯。',
  announcement_join_qq_group: '加入官方 QQ 群',
  announcement_sponsor_title: '赞助支持计划',
  announcement_sponsor_desc:
    '如果您觉得这个项目对您有帮助，欢迎通过赞助支持我们。您的每一份支持都是我们继续前进的动力。',
  ...
  sponsor_title: '赞助我们',
  sponsor_description:
    '您的支持是我们前进的动力，所有赞助将用于服务器、API 调用和其他基础设施支出。',
  ...
  too_many_files: '文件数量超过上限（最多 200 个）',
  files_too_large_12mb: '文件总大小超过上限（解压后累计最大 12MB）',
  ...
  go_group_list: '前往群列表',
  log_help_card_title: '下滑使用LogAgent智能分析或加群寻求帮助~',
  ...
  ai_analysis: '使用LogAgent分析',
  ai_analysis_button: '开始 AI 分析',
  ai_analysis_summary: '分析摘要',
  ai_analysis_severity: '严重程度',
  ai_analysis_issues: '检测到的问题',
  ai_analysis_recommendations: '优化建议',
  ai_analyzing: 'AI 正在分析中，请稍候...',
  ai_analyzing_streaming: 'AI 正在实时分析日志内容...',
  ai_analysis_failed: 'AI 分析加载失败',
  ai_analysis_retry: '重试',
  ai_severity_high: '严重',
  ai_severity_medium: '中等',
  ai_severity_low: '轻微',
  ai_severity_critical: '致命',
  ai_no_issues: '未检测到明显问题',
  ai_issue_type: '问题类型',
  ai_error_not_found: '日志不存在或已被删除',
  ai_error_rate_limit: '请求过于频繁，请稍后重试',
  ai_error_server: '服务器内部错误，AI 分析服务暂时不可用',
  ...
  ai_empty_result: '上游接口未返回内容',
  ai_error_disabled: 'AI 分析服务已关闭',
  ai_status_thinking: '正在思考',
  ai_status_tool: '正在调用工具',
  ai_status_tool_result: '工具返回',
  ai_status_limit: '已达工具调用次数上限',
  ai_status_queued: '排队中，前方约 {count} 个任务',
  ai_status_queued_done: '排队完成，开始分析',
  ai_analysis_process: '分析过程',
  ai_root_cause: '核心根因',
  ai_confidence: '诊断置信度',
  ai_steps: '推荐排障步骤',
  ai_evidence: '支撑证据链',
  ai_view_raw_json: '查看诊断元数据 (JSON)',
  ai_hide_raw_json: '收起诊断元数据',
  ai_tool_arguments: '调用参数',
  attached_files: '附加文件',
  view_file: '查看',
  download_file: '下载',
  file_load_failed: '文件加载失败',
  show_current_file: '显示当前文件',
  main_file: '主文件',
  log_load_failed: '日志加载失败，请稍后重试',
  log_rate_limited: '请求过于频繁，请稍后重试',
  copy_failed: '复制失败',
  mobile_language: '语言'
}
...
export const zhTW = {
  ...
  no_results: '未找到結果',
  friend_links: '友情連結',
  edgeone_distribution: 'EdgeONE 提供 CDN 服務',
  waf_protecting: 'OpenLiteWaf 防護中',
  footer_contact: '聯絡方式',
  terms_of_service: '服務協議',
  legal_provisions: '條款與政策',
  terms_summary: 'LogShare.CN 平台使用規則與權利義務約定',
  privacy_summary: '關於我們在您使用服務期間如何保護及處理您的日誌與遙測數據',
  theme_light: '淺色',
  theme_dark: '深色',
  theme_system: '跟隨系統',
  ...
  save_log: '儲存記錄',
  saving: '儲存中...',
  file_too_large_10mib: '檔案過大 (最大 10 MiB)',
  ...
  button: '按鈕',
  integration_text:
    '直接整合到您的伺服器面板、託管軟體或任何其他平台中。此平台專為高效能自動化而建構，可透過我們的 HTTP API 輕鬆整合到任何現有軟體中。',
  paste_log: '貼上記錄檔案',
  ...
  delete_log_confirm_no_token: '未找到刪除令牌，刪除可能會失敗。',
  delete_log_success: '記錄已成功刪除',
  delete_log_failed: '刪除失敗',
  delete_log_no_token: '未找到刪除令牌，無法刪除記錄',
  deleting: '刪除中...',
  ...
  storage_time: '儲存時間',
  instant_analysis_desc:
    '上傳並分析記錄內容，但不會將其永久儲存到我們的資料庫中。適用於只需要分析結果而不需要分享連結的場景。',
  ...
  announcement_qq_group_desc:
    '歡迎加入我們的官方 QQ 交流群，與其他用戶交流經驗，獲取最新技術支援和更新資訊。',
  announcement_join_qq_group: '加入官方 QQ 群',
  announcement_sponsor_title: '贊助支持計劃',
  announcement_sponsor_desc:
    '如果您覺得這個項目對您有幫助，歡迎通過贊助支持我們。您的每一份支持都是我們繼續前進的動力。',
  ...
  sponsor_title: '贊助我們',
  sponsor_description:
    '您的支持是我們前進的動力，所有贊助將用於伺服器、API 調用和其他基礎設施支出。',
  ...
  too_many_files: '檔案數量超過上限（最多 200 個）',
  files_too_large_12mb: '檔案總大小超過上限（解壓後累計最大 12MB）',
  ...
  selected_count: '已選 {count} / {total}',
  select_all: '全選',
  clear_selection: '取消全選',
  delete_selected: '刪除所選（{count}）',
  remove_file: '移除檔案',
  undo: '復原',
  ...
  join_qq_group_link: '加入官方 QQ 群',
  go_group_list: '前往群列表',
  log_help_card_title: '下滑使用LogAgent智能分析或加群尋求幫助~',
  ...
  ai_analysis_issues: '檢測到的問題',
  ai_analysis_recommendations: '優化建議',
  ai_analyzing: 'AI 正在分析中，請稍候...',
  ai_analyzing_streaming: 'AI 正在即時分析日誌內容...',
  ai_analysis_failed: 'AI 分析加載失敗',
  ai_analysis_retry: '重試',
  ai_severity_high: '嚴重',
  ai_severity_medium: '中等',
  ai_severity_low: '輕微',
  ai_severity_critical: '致命',
  ai_no_issues: '未檢測到明顯問題',
  ai_issue_type: '問題類型',
  ai_error_not_found: '日誌不存在或已被刪除',
  ai_error_rate_limit: '請求過於頻繁，請稍後重試',
  ai_error_server: '伺服器內部錯誤，AI 分析服務暫時不可用',
  ...
  ai_empty_result: '上游介面未回傳內容',
  ai_error_disabled: 'AI 分析服務已關閉',
  ai_status_thinking: '正在思考',
  ai_status_tool: '正在呼叫工具',
  ai_status_tool_result: '工具返回',
  ai_status_limit: '已達工具呼叫次數上限',
  ai_status_queued: '排隊中，前方約 {count} 個任務',
  ai_status_queued_done: '排隊完成，開始分析',
  ai_analysis_process: '分析過程',
  ai_root_cause: '核心根因',
  ai_confidence: '診斷置信度',
  ai_steps: '推薦排障步驟',
  ai_evidence: '支撐證據鏈',
  ai_view_raw_json: '查看診斷元數據 (JSON)',
  ai_hide_raw_json: '收起診斷元數據',
  ai_tool_arguments: '呼叫參數',
  attached_files: '附加檔案',
  view_file: '檢視',
  download_file: '下載',
  file_load_failed: '檔案載入失敗',
  show_current_file: '顯示當前檔案',
  main_file: '主檔案',
  log_load_failed: '日誌載入失敗，請稍後重試',
  log_rate_limited: '請求過於頻繁，請稍後重試',
  copy_failed: '複製失敗',
  mobile_language: '語言'
